...
class StableDiffusion:
    ...
    def load_model(self):
        ...
        if self.model_config.is_xl or self.model_config.is_ssd or self.model_config.is_vega:
            ...
            if device_utils.is_xpu_available() and self.model_config.text_encoder_bits in [4, 8]:
                print_acc("Warning: 4/8-bit quantization is not supported on XPU. Ignoring quantization.")
            else:
